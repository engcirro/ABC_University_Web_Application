...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LastName, FirstName, Address, RegistrationDate")] Student student)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(studentToUpdate, "",
               new string[] { "LastName", "FirstName","Address", "RegistrationDate" }))
            {
                try
                {
                    db.SaveChanges();
